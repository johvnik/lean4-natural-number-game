...
- `Lean4NaturalNumberGame`: the learner-facing template track with theorem statements and `sorry` placeholders.
...
This builds both the template track and the reference solutions.
